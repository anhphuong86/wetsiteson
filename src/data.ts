...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1600566752355-35792bededea?q=80&w=2070&auto=format&fit=crop',
    coverage: '1-1.3 kg/m²',
    dryingTime: {
      vi: 'Khô bề mặt: 2 giờ, Lớp kế tiếp: 3 giờ',
      en: 'Surface dry: 2 hours, Next coat: 3 hours'
  ...
  // SƠN CHỐNG THẤM
  {
    ...
    image: 'https://images.unsplash.com/photo-1541888941257-274045b5c4aa?q=80&w=2070&auto=format&fit=crop',
  ...
  // SƠN PHỦ NỘI THẤT
  {
    ...
    image: 'https://images.unsplash.com/photo-1594488651837-9952da61eba0?q=80&w=2070&auto=format&fit=crop',
    coverage: '12-14 m²/lít/lớp',
    dryingTime: {
      vi: 'Khô bề mặt: 45 phút, Lớp kế tiếp: Sau 4 giờ',
      en: 'Surface dry: 45 mins, Next coat: After 4 hours'
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1621259182978-f09e5e2ca1ff?q=80&w=2070&auto=format&fit=crop',
    coverage: '12-14 m²/lít/lớp',
    dryingTime: {
      vi: 'Khô bề mặt: 45 phút, Lớp kế tiếp: Sau 4 giờ',
      en: 'Surface dry: 45 mins, Next coat: After 4 hours'
  ...
  // SƠN TRẦN & ĐẶC BIỆT
  {
    ...
    description: {
      ...
      en: 'Interior finishing paint specialized for ceilings, high brightness, less splatter, good adhesion.'
    },
    features: {
      vi: ['Siêu trắng', 'Ít văng sơn', 'Bám dính cao'],
      en: ['Ultra white', 'Less splatter', 'High adhesion']
    },
    image: 'https://images.unsplash.com/photo-1558231572-882200be649f?q=80&w=2070&auto=format&fit=crop',
    coverage: '12-14 m²/lít/lớp',
    dryingTime: {
      vi: 'Khô bề mặt: 30 phút, Lớp kế tiếp: Sau 4 giờ',
      en: 'Surface dry: 30 mins, Next coat: After 4 hours'
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1634712282287-14ed57b9cc89?q=80&w=2070&auto=format&fit=crop',
...
export const PARTNERS = [
  { name: 'Thang Long Real', origin: { vi: 'Hợp tác chiến lược', en: 'Strategic Partner' }, logo: '' },
  { name: 'BT Bảo Toàn', origin: { vi: 'Hợp tác chiến lược', en: 'Strategic Partner' }, logo: '' },
  { name: 'DIC', origin: { vi: 'Đối tác dự án', en: 'Project Partner' }, logo: '' },
  { name: 'Geleximco', origin: { vi: 'Đối tác chiến lược', en: 'Strategic Partner' }, logo: '' },
  { name: 'Hòa Phát', origin: { vi: 'Đối tác dự án', en: 'Project Partner' }, logo: '' },
  { name: 'Ecopark', origin: { vi: 'Đối tác dự án', en: 'Project Partner' }, logo: '' }
];

export const PROJECTS = [
  { name: 'Geleximco Hải Phòng', type: { vi: 'Dự án trọng điểm', en: 'Key Project' } },
  { name: 'Elite Park', type: { vi: 'Chung cư cao cấp', en: 'Luxury Apartment' } },
  { name: 'Chung cư Dic Phoenix', type: { vi: 'Căn hộ tiêu chuẩn', en: 'Standard Apartment' } },
  { name: 'Hoa Tiên Paradise', type: { vi: 'Khu nghỉ dưỡng', en: 'Resort' } },
  { name: 'KDC Nghĩa Trung', type: { vi: 'Nhà ở xã hội', en: 'Social Housing' } },
  { name: 'Dự án Fiato Premier', type: { vi: 'Căn hộ cao cấp', en: 'High-end Apartment' } }
];
...
export const CRITERIA_9 = {
  vi: [
    { id: 'G1', label: 'Guarantee', detail: 'Bảo hành' },
    { id: 'G2', label: 'Gratification', detail: 'Sự hài lòng' },
    { id: 'G3', label: 'Gallery', detail: 'Bộ sưu tập' },
    { id: 'G4', label: 'Genuine', detail: 'Chính hãng' },
    { id: 'G5', label: 'Green', detail: 'Xanh lá - Sức sống' },
    { id: 'G6', label: 'Global', detail: 'Toàn cầu' },
    { id: 'G7', label: 'Goal', detail: 'Mục tiêu' },
    { id: 'G8', label: 'Great', detail: 'Tuyệt vời' },
    { id: 'G9', label: 'Growth', detail: 'Sự phát triển' }
  ],
  en: [
    { id: 'G1', label: 'Guarantee', detail: 'Warranty' },
    { id: 'G2', label: 'Gratification', detail: 'Satisfaction' },
    { id: 'G3', label: 'Gallery', detail: 'Collection' },
    { id: 'G4', label: 'Genuine', detail: 'Authentic' },
    { id: 'G5', label: 'Green', detail: 'Green - Vitality' },
    { id: 'G6', label: 'Global', detail: 'Global' },
    { id: 'G7', label: 'Goal', detail: 'Goal' },
    { id: 'G8', label: 'Great', detail: 'Great' },
    { id: 'G9', label: 'Growth', detail: 'Development' }
  ]
};
...
export const TRANSLATIONS = {
  vi: {
    ...
    heroTitle: 'Sơn Xanh Kỹ Thuật Số',
    heroDesc: 'Một thương hiệu của CTCP Quốc tế AIG. Tiên phong ứng dụng công nghệ 4.0 vào sản xuất & vận hành, mang đến giải pháp sơn "xanh" an toàn tuyệt đối cho sức khỏe cộng đồng.',
